...
#
# Email Impacta: hebert.alves@aluno.faculdadeimpacta.com.br
	...
	def preco(self, novo_preco):
		...
		if isinstance(novo_preco, int) or isinstance(novo_preco, float): 
			if novo_preco >= 0:
				...
				raise ValueError('erro ValueError')	
		else:
...
class Ebook(Produto):
	...
	def __init__(self, nome, preco, autor, numero_paginas):
		...
		numero_paginas da seguinte forma:
			- O atributo privad	o autor deve ser inicializado diretamente
			no construtor, sem necessidade de validação.
